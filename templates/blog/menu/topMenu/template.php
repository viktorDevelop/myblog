             <nav class="navbar navbar-expand-lg navbar-light bg-light">
                  <div class="container-fluid">
                    <a class="navbar-brand" href="#">Блог программиста </a>
                ...
                <? //echo "menu arRes";print_r($arResult)?>
  ...
  <div class="navbar-nav-scroll">
    <ul class="navbar-nav bd-navbar-nav flex-row">
      <li class="nav-item">
        <a class="nav-link " href="/" title="В начало">В начало</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" href="/docs/4.0/getting-started/introduction/" title="Документация Bootstrap 4">Документация</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="https://icons.bootstrap-4.ru/" title="Иконки Bootstrap">Иконки</a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="/docs/4.0/examples/" title="Примеры на Bootstrap 4">Примеры</a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="/articles/" title="Статьи">Статьи</a>
      </li>
      <li class="nav-item">                                        
...
v4.0.0</a>
      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="bd-versions">
        <a class="dropdown-item " href="/docs/5.0/" title="Bootstrap - 5"> Последняя (5.0.x)</a>
        <div class="dropdown-divider"></div>
        <a class="dropdown-item " href="/docs/4.6/" title="Версия Bootstrap v4.6.0 (Rus)">v4.6.0</a>
        <a class="dropdown-item " href="/docs/3.4/" title="Версия Bootstrap v3.4.1 (Rus)">v3.4.1</a>
        <a class="dropdown-item " href="/docs/2.3.2/" title="Версия Bootstrap v2.3.2 (Rus)">v2.3.2</a>
        <div class="dropdown-divider"></div>
        <a class="dropdown-item " href="/docs/versions/" title="Все версии">Все версии</a>
      </div>
    </li>
